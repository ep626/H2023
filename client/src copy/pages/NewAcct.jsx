...
function SignInWithGoogle(){
  ...
  .then((result) => {
    ...
    navigate = ('/Selections'); // navigate to the '/Selections' route
    })
  .catch((error) => {
    console.log(error);
  })
      ...
      <div class="container mt-4 border rounded p-3" style={{ maxWidth: 400 }}>
        <form onSubmit={handleSubmit}>
          ...
          <div class = "form-group">
            ...
            <input value = {name} onChange = {(e) => setName(e.target.value)} type = "name" class = "form-control" id = "inputName" placeholder= "Full Name"/>
          </div>
